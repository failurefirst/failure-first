...
*This post synthesizes findings from Reports #174, #183, #184, #259, #269, and #274 of the Failure-First Embodied AI project, alongside external research from Anthropic, Greenblatt et al. (2024), and Turpin et al. (2024). All corpus metrics reference verified canonical figures: 207 models, 133,722 results. The iatrogenic safety framework draws on Illich (1976) and Beauchamp & Childress's principlist ethics.*
