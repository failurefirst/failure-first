...
description: Demonstrates indirect prompt injection attacks where adversarial instructions
  embedded in external content cause LLM-powered tools to exfiltrate data and execute
  code.
date: 2026-02-28
arxiv: '2302.12173'
...
draft: false
pubDate: '2026-02-28'
summary: "Direct prompt injection\u2014where a user deliberately crafts a malicious\
  \ input\u2014requires active attacker participation. But indirect prompt injection\
  \ is more dangerous: an attacker embeds malicious instruc"
---
