...
description: Demonstrates that visual adversarial examples can universally jailbreak
  aligned vision-language models, forcing them to generate harmful content across
  diverse objectives beyond the training...
date: 2026-01-31
arxiv: '2310.03684'
...
draft: false
pubDate: '2026-01-31'
summary: Adversarial attacks on LLMs rely on precise token sequences. Gradient-based
  attacks find subtle perturbations that trigger misalignment. Prompt injection attacks
  use exact strings to confuse instructi
---
