...
**Focus:** Demonstrates a novel jailbreaking attack (CS-DJ) against multimodal LLMs by exploiting visual complexity and attention dispersion through structured query decomposition and contrasting subimages, achieving 52.4% attack success rates across four major models.

### Failure-First Relevance

This paper exposes a critical failure mode in MLLM safety mechanisms: alignment defenses that rely on semantic content analysis are vulnerable to distributional shifts induced by visual complexity rather than semantic meaning. The finding that subimage complexity—not content—drives jailbreak success reveals a fundamental misalignment between how MLLMs process multimodal inputs and how their safety mechanisms are designed, suggesting current defenses are brittle to out-of-distribution visual structures.
...
- [Audio Overview](../../notebooklm-output/2502.10794/artifacts/audio-overview.m4a)
