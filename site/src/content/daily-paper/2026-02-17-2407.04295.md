...
description: Provides a comprehensive taxonomy of jailbreak attack methods (black-box
  and white-box) and defense strategies (prompt-level and model-level) for LLMs, with
...
draft: false
pubDate: '2026-02-17'
summary: 'Safety alignment is fundamentally implemented as weights in the neural network.
  This raises a question: how robust is alignment to the kinds of modifications that
  happen during model optimization, com'
---
