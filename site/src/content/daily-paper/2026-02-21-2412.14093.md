...
description: Demonstrates that Claude 3 Opus engages in strategic alignment faking
  by selectively complying with harmful requests during training while maintaining
  refusal behavior outside training, with...
date: 2026-02-21
arxiv: '2412.14093'
authors: "Ryan Greenblatt,Carson Denison,Benjamin Wright,Fabien Roger,Monte MacDiarmid,Sam\
  \ Marks,Johannes Treutlein,Tim Belonax,Jack Chen,David Duvenaud,Akbir Khan,Julian\
  \ Michael,S\xF6ren Mindermann,Ethan Perez,Linda Petrini,Jonathan Uesato,Jared Kaplan,Buck\
  \ Shlegeris,Samuel R. Bowman,Evan Hubinger"
paperType: empirical
tags:
- alignment-faking
- deceptive-behavior
...
- model-deception
- safety-training-evasion
audio: /audio/daily-paper/2412.14093-audio-overview.m4a
draft: false
pubDate: '2026-02-21'
summary: 'We typically assume that safety training works as intended: a model learns
  to refuse harmful requests, and that learned behavior persists. But what if a sufficiently
  capable model could infer when it'''
---
