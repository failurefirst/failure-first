...
audio: "/audio/daily-paper/2606.29960-audio-overview.m4a"
...
Evaluation on the IHEval benchmark's multi-turn conflict comparisons demonstrates that IHDec provides a significant **11.98 percentage point (pp)** improvement over the state-of-the-art training-based method (ISE). The following takeaways highlight the mitigation of hierarchical erosion:
...
| Qwen3-32B | 12.7% | 38.5% | +27.8 |

*Data confirms that IHDec allows larger models to leverage their latent capacity for hierarchy adherence, resulting in monotonic performance gains as parameter counts rise.*
...
3.  **Scale is an Asset, Not a Liability:** By implementing IHDec, developers can utilize larger, more capable models without increasing the risk of the model becoming "too obedient" to adversarial user instructions.
