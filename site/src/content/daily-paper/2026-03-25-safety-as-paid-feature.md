...
*This post is based on Report #277 (Free-Tier Safety Equity Analysis) of the Failure-First Embodied AI project, which corrected and deepened the original Finding #1 from Report #276. All metrics reference verified canonical figures: 207 models, 133,722 results. The matched-prompt methodology uses McNemar's test on paired binary outcomes, restricted to prompts where both tiers returned substantive (gradeable) responses. Reproducing SQL queries are available in the full report.*

<a id="self-correction"></a>
### A Note on Self-Correction

The original version of this post (published earlier on 2026-03-25) cited the Llama 3.3-70B 3.75:1 ratio as the headline finding. Within hours, our own internal review (Report #277, Clara Oswald) identified the NOT_GRADEABLE confound and corrected the analysis. We updated the post, the ethics report (#280), and flagged the legal memo (LR-64) for correction rather than allowing the inflated figure to persist in our published materials.

This is how safety research should work. A finding that does not survive scrutiny should be corrected, not defended. The DeepSeek R1 finding (p=0.004) holds. The ethical principle -- that safety should not be a paid feature -- holds. The specific numbers have changed because our methodology improved. That is progress, not retraction.
