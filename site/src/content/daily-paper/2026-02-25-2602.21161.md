...
description: "Proposes ActionReasoning, an LLM-driven multi-agent framework that performs explicit physics-aware action reasoning to generate stable robotic brick stacking policies without low-level motor command prediction, instead emitting target waypoints in SE(3) space grounded in physical priors."
date: 2026-02-25
arxiv: "2602.21161"
