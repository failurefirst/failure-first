...
The real-world utility of the method is showcased in contact-rich and bimanual tasks. These include the bimanual coordination required for **Toolbox Packing [SOURCE_IMAGE_4]**, the precision needed for **Glassware Stacking [SOURCE_IMAGE_2]**, and other complex manipulations like **Plug Insertion [SOURCE_IMAGE_6]**, **Jenga Stacking [SOURCE_IMAGE_5]**, and the **BusyBox benchmark [SOURCE_IMAGE_3]**.
