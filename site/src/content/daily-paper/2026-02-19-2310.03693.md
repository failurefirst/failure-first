...
title: Fine-tuning Aligned Language Models Compromises Safety, Even When Users Do
  Not Intend To!
description: Red teaming study demonstrating that fine-tuning safety-aligned LLMs
  with adversarial examples or benign datasets can compromise safety guardrails, with
  quantified jailbreak success rates and cost...
date: 2026-02-19
arxiv: '2310.03693'
authors: Xiangyu Qi,Yi Zeng,Tinghao Xie,Pin-Yu Chen,Ruoxi Jia,Prateek Mittal,Peter
  Henderson
paperType: empirical
tags:
...
draft: false
pubDate: '2026-02-19'
summary: Alignment training creates a fragile veneer of safety that can be stripped
  away with surprising ease. We invest heavily in RLHF and instruction-tuning to teach
  models to refuse harmful requests, assum
---
