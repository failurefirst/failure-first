...
2.  **Preservation of Semantic Priors:** The "Ours w/o event" ablation demonstrates that Event-VLA maintains a 96.2% success rate in normal lighting even when sensors are absent. This "zero-detriment" result proves that the interface does not degrade the original VLA capabilities.
