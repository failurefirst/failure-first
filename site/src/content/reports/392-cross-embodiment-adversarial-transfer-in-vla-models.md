...
*Publication note (2026-08-24, [#1043](https://github.com/adrianwedd/failure-first-embodied-ai/issues/1043) DD-08): This paper was originally published on 2026-03-01 as Report 42. During the May 2026 content migration to the current report numbering scheme it was dropped from the published corpus, while blog posts continued to cite it, leaving dead links on failurefirst.org. It is restored here verbatim from repository history and renumbered Report 392 to avoid colliding with the unrelated current Reports 42 under the new scheme. The body text is unchanged apart from this note.*
