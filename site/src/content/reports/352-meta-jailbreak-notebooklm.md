...
>
> Further additions (regulatory-vocabulary glossary, Mistake #31 generalization to a standards-contribution, reinsurer leading-indicator paragraph, underclaim callouts from River, and a buyer/operator implications subsection from Ace) are tracked as open follow-ups for a v3 revision and are not in v2.
