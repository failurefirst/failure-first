...
export default defineConfig({
  ...
  redirects: {
    ...
    '/daily-paper/240105566/': '/daily-paper/sleeper-agents-training-deceptive-llms-that-persist-through-safety-training/',
    ...
    '/daily-paper/240618510/': '/daily-paper/wildteaming-at-scale-from-in-the-wild-jailbreaks-to-adversarially-safer-langu/',
