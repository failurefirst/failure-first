...
export default defineConfig({
  ...
  redirects: {
    ...
    '/daily-paper/231003693/': '/daily-paper/fine-tuning-aligned-llms-compromises-safety/',
    ...
    '/daily-paper/240105566/': '/daily-paper/sleeper-agents-deceptive-training/',
    ...
    '/daily-paper/240618510/': '/daily-paper/wildguard-open-safety-moderation/',
    ...
    '/daily-paper/260222642/': '/daily-paper/compress-the-easy,-explore-the-hard-difficulty-aware-entropy-regularization-for/',
    ...
    '/daily-paper/260317368/': '/daily-paper/towards-safer-large-reasoning-models-by-promoting-safety-decision-making-before/',
    ...
    '/daily-paper/260324329/': '/daily-paper/gameplayqa-a-benchmarking-framework-for-decision-dense-pov-synced-multi-video-u/',
